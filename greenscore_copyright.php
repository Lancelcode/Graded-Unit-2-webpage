...
// FIX: nav.php and head.php were included before the DOCTYPE declaration
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<main class="d-flex flex-column min-vh-100">
    <div class="container py-5 flex-grow-1">
        <div class="content-wrapper">
            ...
            <p>If you wish to request permission for other uses, or have questions about our
            copyright policies, please contact us at:</p>
