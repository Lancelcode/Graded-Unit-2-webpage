...
$q = "SELECT username, email, created_at, status FROM new_users WHERE id = ?";
            ...
            <div class="card card-bg shadow-sm h-100">
                <div class="card-body d-flex flex-column">
                    ...
                    <?php
                      ...
                      switch ($status) {
                        case 'inactive':    $btnClass = 'btn-warning'; break;
                        case 'deactivated': $btnClass = 'btn-dark';    break;
                        default:            $btnClass = 'btn-info';    break;
                      }
                    ?>
