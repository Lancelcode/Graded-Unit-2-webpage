...
(35, 'fumancher', 'fu@fu.com', '$2y$10$n4vh11tJxOgY5MPkKfH5Q.0XKnyot30AWMCy.TAAKWC3KYn7MjKgy', 'user', '2025-05-01 17:34:52', 'active', 'fum fum fum co', 'smoke', '0000000000'),
(36, 'admin', 'admin@greenscore.com', '$2y$10$VdFdg3VD8VoaIuHaSG327u3.y8Qy8PHuZ.orewXdhofHYxvgJP09q', 'admin', '2025-05-01 21:47:23', 'active', 'GreenScore', 'Administrator', '0000000000'),
(37, 'jamoncin', 'jamoncin@example.com', '$2y$10$Hwwe8aOkZ0lGX1bpCtjP7uOwoEAnIdCStqnJ4U0KuoMzkignZKG2i', 'admin', '2025-05-02 00:26:03', 'inactive', 'JAM company', 'pig', '0645217654'),
(39, 'Joe', 'joe@joe.com', '$2y$10$gDVJKK.y0c99dkaMLJrdZOObGQsRo5AN7YlsPglg1vZvJU4IooQ6S', 'user', '2025-05-02 12:24:05', 'active', 'joe.Corporation', 'Joe DOE', '5555555555'),
(40, 'cris', 'crif@gmail.com', '$2y$10$7nHeemAINX68isS/zeOY4OYXpof6s48TZ6RAQgfuPOyaWvnwc/o4O', 'user', '2025-05-02 17:20:19', 'active', 'Crif', 'Crif', '0889795668'),
(41, 'Juan', 'juan@example.com', '$2y$10$sZKDAfwxbh4GUbD8Z18Spe3DmyNcziIz6cfIb2gR3taMoRri68hau', 'user', '2025-05-02 19:09:47', 'deactivated', 'One', 'Juan', '1111111111'),
(47, 'test2', 'test2@example.com', '$2y$10$NQO3zCquzyQNbtt4bEGIsO.FvAF685X.2qwLUxgVMmZs.nGTp.u2O', 'user', '2025-05-07 14:55:47', 'deactivated', 'test2', 'test2', '0000000000');
