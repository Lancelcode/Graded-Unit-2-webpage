...
<div class="container mt-5">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            <img src="assets/images/earth-hands.jpg" alt="Protecting Earth" class="img-fluid rounded shadow">
        </div>
        <div class="col-md-6">
            <h3 class="text-success">🌱 Small Actions, Big Impact</h3>
            <p>
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6 order-md-2">
            <img src="assets/images/team-green.jpg" alt="Green Team" class="img-fluid rounded shadow">
        </div>
        <div class="col-md-6 order-md-1">
            <h3 class="text-success">👥 Built for Real People</h3>
            <p>
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            <img src="assets/images/sdg.jpg" alt="Sustainable Development Goals" class="img-fluid rounded shadow">
        </div>
        <div class="col-md-6">
            <h3 class="text-success">📚 Backed by Global Goals</h3>
            <p>
    ...
    <div class="text-center mb-5">
        ...
        <a href="green_calculator.php" class="btn btn-success btn-lg mt-3">Get Started</a>
    </div>
</div>
